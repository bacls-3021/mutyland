...
ActiveRecord::Schema.define(version: 2022_09_28_151952) do
  ...
  create_table "results", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_results_on_product_id"
    t.index ["website_id"], name: "index_results_on_website_id"
  end
